...
namespace Hosting.Services.Web.UnitTests
{
		...
		where TContext : ServiceContext
	{
		public ListenerValidator()
		{
			...
			KestrelOptionsAction = (webHostBuilderContext, provider, serverOptions) =>
			{
		...
		public Action<WebHostBuilderContext, IServiceProvider, KestrelServerOptions> KestrelOptionsAction { get; }
