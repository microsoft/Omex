...
namespace Microsoft.Omex.Gating
{
	...
	public class Gates
	{
		...
		public IGate GetGate(string gateName)
		{
			...
			{
				ULSLogging.LogTraceTag(0x2384d540 /* tag_97nva */, Categories.GateSelection,
			...
			private IGate Gate
			{
				get
				{
					...
					if (gate == null)
					{
						...
						ULSLogging.LogTraceTag(0x2384d541 /* tag_97nvb */, Categories.GateSelection, Levels.Verbose,
