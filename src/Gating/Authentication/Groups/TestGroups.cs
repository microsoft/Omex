...
namespace Microsoft.Omex.Gating.Authentication.Groups
{
	...
	public class TestGroups : ITestGroups
	{
		...
		{
			m_testGroupsDataSetLoader = Code.ExpectsArgument(testGroupsLoader, nameof(testGroupsLoader), TaggingUtilities.ReserveTag(0x23850703 /* tag_97q2d */));
		}
		...
		{
			if (!Code.ValidateNotNullOrWhiteSpaceArgument(groupNames, nameof(groupNames), TaggingUtilities.ReserveTag(0x23850704 /* tag_97q2e */)))
			{
				return false;
			}
		...
		{
			if (!Code.ValidateArgument(identity, nameof(identity), TaggingUtilities.ReserveTag(0x23850705 /* tag_97q2f */)))
			{
		...
		{
			if (!Code.ValidateNotNullOrWhiteSpaceArgument(userEmail, nameof(userEmail), TaggingUtilities.ReserveTag(0x23850706 /* tag_97q2g */)))
			{
				return Enumerable.Empty<string>();
			}
		...
		{
			if (!Code.ValidateNotNullOrWhiteSpaceArgument(groupName, nameof(groupName), TaggingUtilities.ReserveTag(0x23850708 /* tag_97q2i */)))
			{
				return Enumerable.Empty<string>();
			}
		...
		{
			if (!Code.ValidateNotNullOrWhiteSpaceArgument(groupNames, nameof(groupNames), TaggingUtilities.ReserveTag(0x23850709 /* tag_97q2j */)) ||
				!Code.ValidateArgument(identity, nameof(identity), TaggingUtilities.ReserveTag(0x2385070a /* tag_97q2k */)))
			{
				return false;
			}
		...
		{
			if (!Code.ValidateNotNullOrWhiteSpaceArgument(groupNames, nameof(groupNames), TaggingUtilities.ReserveTag(0x2385070b /* tag_97q2l */)) ||
				!Code.ValidateNotNullOrWhiteSpaceArgument(userEmail, nameof(userEmail), TaggingUtilities.ReserveTag(0x2385070c /* tag_97q2m */)))
			{
				return false;
			}
		...
		private ITestGroupsDataSet GetTestGroupsDataSet()
		{
			...
			if (dataSet == null)
			{
				ULSLogging.LogTraceTag(0x238503d2 /* tag_97qps */, Categories.TestGroupsDataSet, Levels.Error,
					"TestGroupsDataSet is null, TestGroups authentication will fail.");
			}
			else if (!dataSet.IsHealthy)
			{
				ULSLogging.LogTraceTag(0x238503d3 /* tag_97qpt */, Categories.TestGroupsDataSet, Levels.Error,
