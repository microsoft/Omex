/*****************************************************************************
	TestGroupsDataSet.cs

	Loads test groups data set to guard access for testing in production
******************************************************************************/
...
namespace Microsoft.Omex.Gating.Authentication.Groups
{
	...
	public class TestGroupsDataSet<T> : ConfigurationDataSet<T>, ITestGroupsDataSet where T : ConfigurationDataSetLogging, new()
	{
		...
		{
			TestGroupsResourceName = Code.ExpectsNotNullOrWhiteSpaceArgument(testGroupsResourceName, nameof(testGroupsResourceName), TaggingUtilities.ReserveTag(0x23850702 /* tag_97q2c */));
		...
		public override bool Load(IDictionary<string, IResourceDetails> resources)
		{
			...
			if (!resourceStatus)
			{
				ULSLogging.LogCodeErrorTag(0x238503c6 /* tag_97qpg */, Categories.TestGroupsDataSet, false,
					true, "Failed to retrieve resource content for TestGroupsDataSet.");
			}
			else if (file == null || file.Length == 0)
			{
				ULSLogging.LogCodeErrorTag(0x238503c7 /* tag_97qph */, Categories.TestGroupsDataSet, false,
		...
		public IEnumerable<string> GetUserGroups(string user)
		{
			...
			{
				ULSLogging.LogCodeErrorTag(0x238503c8 /* tag_97qpi */, Categories.TestGroupsDataSet, false,
		...
		public IEnumerable<string> GetGroupUsers(string groupName)
		{
			...
			{
				ULSLogging.LogCodeErrorTag(0x238503c9 /* tag_97qpj */, Categories.TestGroupsDataSet, false,
			...
			{
				ULSLogging.LogCodeErrorTag(0x238503ca /* tag_97qpk */, Categories.TestGroupsDataSet, false,
		...
		private void Load(byte[] file)
		{
			...
			{
				ULSLogging.ReportExceptionTag(0x238503cb /* tag_97qpl */, Categories.TestGroupsDataSet, exception,
			...
			out Dictionary<string, List<string>> userGroups, out Dictionary<string, List<string>> groupUsers)
		{
			...
			{
				ULSLogging.LogCodeErrorTag(0x238503cc /* tag_97qpm */, Categories.TestGroupsDataSet, false,
			...
			foreach (Configuration.TestGroupsTestGroup testGroup in testGroupsRaw.TestGroup)
			{
				...
				{
					ULSLogging.LogCodeErrorTag(0x238503cd /* tag_97qpn */, Categories.TestGroupsDataSet, false,
				...
				{
					ULSLogging.LogCodeErrorTag(0x238503ce /* tag_97qpo */, Categories.TestGroupsDataSet, false,
				...
				{
					ULSLogging.LogCodeErrorTag(0x238503cf /* tag_97qpp */, Categories.TestGroupsDataSet, false,
				...
				{
					ULSLogging.LogCodeErrorTag(0x238503d0 /* tag_97qpq */, Categories.TestGroupsDataSet, false,
		...
		private void UpdateGroups(Dictionary<string, List<string>> userGroups, Dictionary<string, List<string>> groupUsers, string user, string groupName)
		{
			...
			{
				ULSLogging.LogCodeErrorTag(0x238503d1 /* tag_97qpr */, Categories.TestGroupsDataSet, false,
