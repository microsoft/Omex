/***************************************************************************************************
	...
	GateContext, handles the current active gates and manages
	which gates are applicable to the current request
***************************************************************************************************/
...
namespace Microsoft.Omex.Gating
{
	...
	public class GateContext : IGateContext
	{
		...
		public GateContext(IGatedRequest request, IMachineInformation machineInformation, IExperimentContext experimentContext, IKnownIPAddresses knownIpAddresses = null, IGateSettings settings = null)
		{
			Request = request;
		...
		/// The experiment context
		/// </summary>
		protected IKnownIPAddresses KnownIpAddresses { get; set; }
		...
		private bool CheckGateApplicabilityForBrowser(IDictionary<UserAgentBrowser, HashSet<int>> browsers)
		{
			Tuple<UserAgentBrowser, int> browser = Request?.GetUserAgentBrowser();
			if (browser == null)
			{
