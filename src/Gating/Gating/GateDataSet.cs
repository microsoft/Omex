/***************************************************************************************************
	...
	GateDataSet handles reading from the gates file and manages reloading of gates
	as needed.
***************************************************************************************************/
...
namespace Microsoft.Omex.Gating
{
	...
	public class GateDataSet<T> : ConfigurationDataSet<T>, IGateDataSet where T : ConfigurationDataSetLogging, new()
	{
		...
		{
			m_gatesResourceName = Code.ExpectsNotNullOrWhiteSpaceArgument(gatesResourceName, "gatesResourceName", TaggingUtilities.ReserveTag(0x23850604 /* tag_97qye */));
			m_testGroupsResourceName = Code.ExpectsNotNullOrWhiteSpaceArgument(testGroupsResourceName, "testGroupsResourceName", TaggingUtilities.ReserveTag(0x23850605 /* tag_97qyf */));
		...
		public virtual IGate GetGate(string gateName)
		{
			...
			{
				ULSLogging.LogTraceTag(0x238502c0 /* tag_97qla */, Categories.GateDataSet,
		...
		public override bool Load(IDictionary<string, IResourceDetails> resources)
		{
			...
			{
				ULSLogging.LogCodeErrorTag(0x238502c2 /* tag_97qlc */, Categories.GateDataSet, false,
					true, "Failed to retrieve Gates resource content for GateDataSet.");
			}
			else if (gateContent == null || gateContent.Length == 0)
			{
				ULSLogging.LogCodeErrorTag(0x238502c3 /* tag_97qld */, Categories.GateDataSet, false,
		...
		private void Load(byte[] file)
		{
			try
			{
				using (MemoryStream stream = new MemoryStream(file, false))
				{
					...
					if (gateObject == null)
					{
						ULSLogging.LogCodeErrorTag(0x238502c4 /* tag_97qle */, Categories.GateDataSet, false,
					...
					foreach (IGate gate in m_gates.Values)
					{
						...
						{
							ULSLogging.LogCodeErrorTag(0x238502c5 /* tag_97qlf */, Categories.GateDataSet, false, true,
			...
			{
				ULSLogging.ReportExceptionTag(0x238502c6 /* tag_97qlg */, Categories.GateDataSet, exception,
		...
		private Dictionary<string, IGate> LoadGates(GatingConfiguration.Gates configurationGates)
		{
			...
			{
				ULSLogging.LogCodeErrorTag(0x238502c7 /* tag_97qlh */, Categories.GateDataSet, false,
			...
			if (configurationGates.Gate != null || configurationGates.Experiment != null)
			{
				...
				if (configurationGates.Gate != null)
				{
					foreach (GatingConfiguration.GateType configurationGate in configurationGates.Gate)
					{
						...
						{
							ULSLogging.LogTraceTag(0x238502c8 /* tag_97qli */, Categories.GateDataSet, Levels.Error,
						...
						if (gates.ContainsKey(configurationGate.Name))
						{
							...
							{
								ULSLogging.LogTraceTag(0x238502c9 /* tag_97qlj */, Categories.GateDataSet, Levels.Error,
				...
				if (configurationGates.Experiment != null)
				{
					foreach (GatingConfiguration.GatesExperiment experiment in configurationGates.Experiment)
					{
						...
						{
							ULSLogging.LogTraceTag(0x238502ca /* tag_97qlk */, Categories.GateDataSet, Levels.Error,
						...
						foreach (GatingConfiguration.ExperimentGateType configurationExperimentGate in experiment.ExperimentGate)
						{
							if (gates.ContainsKey(configurationExperimentGate.Name))
							{
								...
								{
									ULSLogging.LogTraceTag(0x238502cb /* tag_97qll */, Categories.GateDataSet, Levels.Error,
										true, "Gate '{0}' appears multiple times. Each gate must be unique.",
		...
		private void ConsolidateUsers(Gate gate, IGate parent)
		{
			if (parent.UserTypes == UserGroupTypes.None)
			{
				...
				ULSLogging.LogTraceTag(0x238502cc /* tag_97qlm */, Categories.GateDataSet, Levels.Verbose, true,
			...
			else
			{
				...
				foreach (string clientName in gate.ClientVersions.Keys)
				{
					if (!parent.ClientVersions.TryGetValue(clientName, out RequiredClient parentClient))
					{
						...
						ULSLogging.LogTraceTag(0x238502cd /* tag_97qln */, Categories.GateDataSet, Levels.Error,
		...
		{
			IDictionary<UserAgentBrowser, HashSet<int>> parentGateBrowsers;
			IDictionary<UserAgentBrowser, HashSet<int>> childGateBrowsers;
			...
			{
				IDictionary<UserAgentBrowser, HashSet<int>> browsers = new Dictionary<UserAgentBrowser, HashSet<int>>();

				foreach (KeyValuePair<UserAgentBrowser, HashSet<int>> childGateBrowser in childGateBrowsers
		...
		private void BuildParentHierarchy(GatingConfiguration.Gates configurationGates, Dictionary<string, Gate> gates)
		{
			...
			{
				ULSLogging.LogTraceTag(0x238502ce /* tag_97qlo */, Categories.GateDataSet, Levels.Error,
			...
			HashSet<string> gatesToRemove)
		{
			...
			{
				ULSLogging.LogTraceTag(0x238502cf /* tag_97qlp */, Categories.GateDataSet, Levels.Error,
			...
			{
				ULSLogging.LogTraceTag(0x238502d0 /* tag_97qlq */, Categories.GateDataSet, Levels.Error,
			...
			{
				ULSLogging.LogTraceTag(0x238502d1 /* tag_97qlr */, Categories.GateDataSet, Levels.Error,
			...
			while (ancestor != null)
			{
				if (ancestors.Contains(ancestor.Name))
				{
					...
					ULSLogging.LogTraceTag(0x238502d2 /* tag_97qls */, Categories.GateDataSet, Levels.Error,
		...
		private void ReadHostEnvironments(GatingConfiguration.BaseGateType configurationGate, Gate gate)
		{
			...
			{
				if (environment.Name == GatingConfiguration.BaseGateTypeHostEnvironmentName.None)
				{
				...
				{
					ULSLogging.LogTraceTag(0x238502d3 /* tag_97qlt */, Categories.GateDataSet, Levels.Error,
		...
		private void ReadKnownIPRanges(GatingConfiguration.BaseGateType configurationGate, Gate gate)
		{
			...
			foreach (GatingConfiguration.BaseGateTypeKnownIPRange ipRange in configurationGate.KnownIPRanges)
			{
				...
				{
					ULSLogging.LogTraceTag(0x238502d4 /* tag_97qlu */, Categories.GateDataSet, Levels.Error,
		...
		private void ReadBrowsers(GatingConfiguration.BaseGateType configurationGate, Gate gate)
		{
			...
			IDictionary<UserAgentBrowser, HashSet<int>> readBrowsers = new Dictionary<UserAgentBrowser, HashSet<int>>();
			...
			{
				if (!Enum.TryParse(browser.Name.ToString(), out UserAgentBrowser userAgentBrowser))
				{
					ULSLogging.LogTraceTag(0x238502d5 /* tag_97qlv */, Categories.GateDataSet, Levels.Error,
						false, "Unable to parse browser name for '{0}'", browser.Name.ToString());
				...
				foreach (GatingConfiguration.BrowserFormatBrowserVersion browserVersion in browser.Version)
				{
					...
					{
						ULSLogging.LogTraceTag(0x238502d6 /* tag_97qlw */, Categories.GateDataSet, Levels.Error,
		...
		private void ReadReleasePlan(GatingConfiguration.GateType configurationGate, Gate gate)
		{
			...
			foreach (GatingConfiguration.BaseGateType configurationReleaseGate in configurationGate.ReleasePlan)
			{
				...
				{
					ULSLogging.LogTraceTag(0x238502d7 /* tag_97qlx */, Categories.GateDataSet, Levels.Error,
		...
		private void ReadMarkets(GatingConfiguration.BaseGateType configurationGate, Gate gate)
		{
			...
			foreach (GatingConfiguration.BaseGateTypeMarket market in configurationGate.Markets)
			{
				...
				{
					ULSLogging.LogTraceTag(0x238502d8 /* tag_97qly */, Categories.GateDataSet, Levels.Error,
				...
				{
					ULSLogging.LogTraceTag(0x238502d9 /* tag_97qlz */, Categories.GateDataSet, Levels.Error,
		...
		private void ReadEnvironments(GatingConfiguration.BaseGateType configurationGate, Gate gate)
		{
			...
			foreach (GatingConfiguration.BaseGateTypeEnvironment environment in configurationGate.Environments)
			{
				...
				{
					ULSLogging.LogTraceTag(0x238502da /* tag_97ql0 */, Categories.GateDataSet, Levels.Error, true,
				...
				{
					ULSLogging.LogTraceTag(0x238502db /* tag_97ql1 */, Categories.GateDataSet, Levels.Error, true,
		...
		private void ReadClients(GatingConfiguration.BaseGateType configurationGate, Gate gate)
		{
			...
			foreach (GatingConfiguration.BaseGateTypeClientVersion clientVersion in configurationGate.ClientVersions)
			{
				...
				{
					ULSLogging.LogTraceTag(0x238502dc /* tag_97ql2 */, Categories.GateDataSet, Levels.Error,
				...
				if (!string.IsNullOrWhiteSpace(clientVersion.MaxVersion))
				{
					...
					{
						ULSLogging.LogTraceTag(0x238502de /* tag_97ql4 */, Categories.GateDataSet, Levels.Error,
				...
				if (!string.IsNullOrWhiteSpace(clientVersion.MinVersion))
				{
					...
					{
						ULSLogging.LogTraceTag(0x238502df /* tag_97ql5 */, Categories.GateDataSet, Levels.Error,
				...
				if (!string.IsNullOrWhiteSpace(clientVersion.VersionRange))
				{
					...
					foreach (string range in clientVersion.VersionRange.Split(s_versionRangeDelimiters, StringSplitOptions.RemoveEmptyEntries))
					{
						...
						if (versions.Length == 2)
						{
							...
							{
								ULSLogging.LogTraceTag(0x238502e0 /* tag_97ql6 */, Categories.GateDataSet, Levels.Error,
		...
		private RequiredApplication ReadOverride(GatingConfiguration.BaseGateTypeClientVersionApplicationOverride clientVersionOverride)
		{
			...
			{
				ULSLogging.LogTraceTag(0x238502e1 /* tag_97ql7 */, Categories.GateDataSet, Levels.Error,
			...
			{
				ULSLogging.LogTraceTag(0x238502e2 /* tag_97ql8 */, Categories.GateDataSet, Levels.Error,
			...
			if (!string.IsNullOrWhiteSpace(clientVersionOverride.MaxVersion))
			{
				...
				{
					ULSLogging.LogTraceTag(0x23850300 /* tag_97qma */, Categories.GateDataSet, Levels.Error,
			...
			if (!string.IsNullOrWhiteSpace(clientVersionOverride.MinVersion))
			{
				...
				{
					ULSLogging.LogTraceTag(0x23850301 /* tag_97qmb */, Categories.GateDataSet, Levels.Error,
			...
			if (!string.IsNullOrWhiteSpace(clientVersionOverride.VersionRange))
			{
				...
				foreach (string range in clientVersionOverride.VersionRange.Split(s_versionRangeDelimiters, StringSplitOptions.RemoveEmptyEntries))
				{
					...
					if (versions.Length == 2)
					{
						...
						{
							ULSLogging.LogTraceTag(0x23850302 /* tag_97qmc */, Categories.GateDataSet, Levels.Error,
		...
		private RequiredClient MergeExistingClient(Gate gate, RequiredClient client)
		{
			...
			{
				ULSLogging.LogTraceTag(0x23850303 /* tag_97qmd */, Categories.GateDataSet, Levels.Error,
		...
		private void ReadUsers(GatingConfiguration.BaseGateType configurationGate, Gate gate)
		{
			...
			foreach (GatingConfiguration.BaseGateTypeUserGroup group in configurationGate.UserGroups)
			{
				switch (group.Type)
				{
					...
					case GatingConfiguration.BaseGateTypeUserGroupType.CustomGroup:
						...
						{
							ULSLogging.LogTraceTag(0x23850304 /* tag_97qme */, Categories.GateDataSet, Levels.Error,
						...
						else
						{
							...
							{
								ULSLogging.LogTraceTag(0x23850305 /* tag_97qmf */, Categories.GateDataSet, Levels.Error,
					...
					case GatingConfiguration.BaseGateTypeUserGroupType.FeatureTeam:
						...
						{
							ULSLogging.LogTraceTag(0x23850306 /* tag_97qmg */, Categories.GateDataSet, Levels.Error,
								true, "Gate '{0}' contains a user group that is null or only whitespace",
								gate.Name);
						}
						else
			...
			if (userTypes == UserGroupTypes.None)
			{
				if (users != null)
				{
					ULSLogging.LogTraceTag(0x23850307 /* tag_97qmh */, Categories.GateDataSet, Levels.Error,
		...
		private uint? ReadExperimentalWeight(GatingConfiguration.ExperimentGateType configurationExperimentGate, string gateName)
		{
			...
			{
				ULSLogging.LogTraceTag(0x23850308 /* tag_97qmi */, Categories.GateDataSet, Levels.Error, true,
		...
		private TestGroupsDataSet<T> LoadTestGroupsDataSet(IDictionary<string, IResourceDetails> resources)
		{
			...
			{
				ULSLogging.LogCodeErrorTag(0x23850309 /* tag_97qmj */, Categories.GateDataSet, false, true,
			...
			{
				ULSLogging.LogCodeErrorTag(0x2385030a /* tag_97qmk */, Categories.GateDataSet, false,
