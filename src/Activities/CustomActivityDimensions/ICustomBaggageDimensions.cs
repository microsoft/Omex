...
{
	/// <summary>
	/// Define custom metric dimensions which are extracted from Activity Baggage  by <see cref="ActivityMetricsSender.SendActivityMetric"/>
	...
	/// </summary>
	public interface ICustomBaggageDimensions
	{
		/// <summary>
