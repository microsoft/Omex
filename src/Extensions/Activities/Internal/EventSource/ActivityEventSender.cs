...
namespace Microsoft.Omex.Extensions.Activities
{
	...
	{
		public ActivityEventSender(ActivityEventSource eventSource, IExecutionContext executionContext, ILogger<ActivityEventSender> logger, ActivityMetricsSender metricsSender)
		{
