/*****************************************************************************************************
	DocumentDbDatabaseAdapter.cs

	Copyright (c) Microsoft Corporation

	Documentdb adapter for Databases.
******************************************************************************************************/
...
namespace Microsoft.Omex.DocumentDb
{
    ...
    public partial class DocumentDbAdapter : IDocumentDbAdapter
    {
        ...
        {
            Code.ExpectsNotNullOrWhiteSpaceArgument(dbId, nameof(dbId), 0x238545e1 /* tag_97ux7 */);
        ...
        {
            Code.ExpectsArgument(database, nameof(database), 0x238545e2 /* tag_97ux8 */);

            IDocumentClient client = await GetDocumentClientAsync();
            return await DocumentDbAdapter.ExecuteAndLogAsync(0x238545e3 /* tag_97ux9 */,
        ...
        {
            Code.ExpectsNotNullOrWhiteSpaceArgument(dbId, nameof(dbId), 0x23854600 /* tag_97uya */);
        ...
        public async Task<ResourceResponse<Database>> DeleteDatabaseAsync(
            string dbId, RequestOptions requestOptions = null)
        {
            Code.ExpectsNotNullOrWhiteSpaceArgument(dbId, nameof(dbId), 0x23854601 /* tag_97uyb */);
