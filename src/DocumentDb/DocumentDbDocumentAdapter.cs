/*****************************************************************************************************
	DocumentDbDocumentAdapter.cs

	Copyright (c) Microsoft Corporation

	Documentdb adapter for Documents.
******************************************************************************************************/
...
namespace Microsoft.Omex.DocumentDb
{
    ...
    public partial class DocumentDbAdapter : IDocumentDbAdapter
    {
        ...
        {
            Code.ExpectsNotNullOrWhiteSpaceArgument(dbId, nameof(dbId), 0x2385458f /* tag_97uwp */);
            Code.ExpectsNotNullOrWhiteSpaceArgument(collectionId, nameof(collectionId), 0x23854590 /* tag_97uwq */);
            Code.ExpectsArgument(document, nameof(document), 0x23854591 /* tag_97uwr */);
        ...
        {
            Code.ExpectsNotNullOrWhiteSpaceArgument(dbId, nameof(dbId), 0x23854593 /* tag_97uwt */);
            Code.ExpectsNotNullOrWhiteSpaceArgument(collectionId, nameof(collectionId), 0x23854594 /* tag_97uwu */);
            Code.ExpectsArgument(document, nameof(document), 0x23854595 /* tag_97uwv */);

            Uri collectionUri = UriFactory.CreateDocumentCollectionUri(dbId, collectionId);

            IDocumentClient client = await GetDocumentClientAsync();

            return await DocumentDbAdapter.ExecuteAndLogAsync(0x23854596 /* tag_97uww */,
                async () =>
                {
                    try
                    {
        ...
        {
            Code.ExpectsNotNullOrWhiteSpaceArgument(dbId, nameof(dbId), 0x23854597 /* tag_97uwx */);
            Code.ExpectsNotNullOrWhiteSpaceArgument(collectionId, nameof(collectionId), 0x23854598 /* tag_97uwy */);
            Code.ExpectsNotNullOrWhiteSpaceArgument(docId, nameof(docId), 0x23854599 /* tag_97uwz */);
            Code.ExpectsNotNullOrWhiteSpaceArgument(partitionKey, nameof(partitionKey), 0x2385459a /* tag_97uw0 */);
        ...
        {
            Code.ExpectsNotNullOrWhiteSpaceArgument(dbId, nameof(dbId), 0x2385459b /* tag_97uw1 */);
            Code.ExpectsNotNullOrWhiteSpaceArgument(collectionId, nameof(collectionId), 0x2385459c /* tag_97uw2 */);
            Code.ExpectsNotNullOrWhiteSpaceArgument(docId, nameof(docId), 0x2385459d /* tag_97uw3 */);
        ...
        {
            Code.ExpectsNotNullOrWhiteSpaceArgument(dbId, nameof(dbId), 0x2385459f /* tag_97uw5 */);
            Code.ExpectsNotNullOrWhiteSpaceArgument(collectionId, nameof(collectionId), 0x238545a0 /* tag_97uw6 */);
            Code.ExpectsNotNullOrWhiteSpaceArgument(docId, nameof(docId), 0x238545a1 /* tag_97uw7 */);

            IDocumentClient client = await GetDocumentClientAsync();


            return await DocumentDbAdapter.ExecuteAndLogAsync(0x238545a2 /* tag_97uw8 */,
                async () =>
                {
                    try
                    {
        ...
        {
            Code.ExpectsNotNullOrWhiteSpaceArgument(dbId, nameof(dbId), 0x238545a3 /* tag_97uw9 */);
            Code.ExpectsNotNullOrWhiteSpaceArgument(collectionId, nameof(collectionId), 0x238545c0 /* tag_97uxa */);
            Code.ExpectsNotNullOrWhiteSpaceArgument(docId, nameof(docId), 0x238545c1 /* tag_97uxb */);
            Code.ExpectsArgument(converter, nameof(converter), 0x238545c2 /* tag_97uxc */);
